...
function srchDone(pid){
    top.restoreSession();
    console.log(pid);
    document.location.href = "./../../patient_file/primary_support/primary_support_add.php?sid=" + pid + "&patient_id=" + <?php echo $patient_id ?>;
}
//-->
...
<body class="body_top">
    <div>
        <a href="../patient_file/primary_support/primary_support.php?patient_id=<?php echo $patient_id?>" class="css_button" onclick="top.restoreSession()">
...
<form action='new_primary_support_comprehensive_save.php' name='demographics_form' id="DEM"  method='post' onsubmit='return submitme(<?php echo $GLOBALS['new_validate'] ? 1 : 0;?>,event,"DEM",constraints)'>
