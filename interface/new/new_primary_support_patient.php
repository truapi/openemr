...
/**
 * $patient_id is being used for primary support page
 * new page is being used for insert new/search and primary support/search/add
 */
$patient_id = isset($_GET['patient_id']) ? $_GET['patient_id'] : "";

if ($GLOBALS['full_new_patient_form']) {
    require("new_primary_support_comprehensive.php");
    exit;
}
...
<form name='new_patient' method='post' action="new_primary_support_patient_save.php"
