...
MySQL - 10.1.38-MariaDB : Database - openemr
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`openemr` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `lang_definitions` (
  ...
  KEY `cons_id` (`cons_id`)
) ENGINE=InnoDB AUTO_INCREMENT=183896 DEFAULT CHARSET=utf8;
